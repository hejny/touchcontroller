...
export default class BoundingBox {
    ...
    static fromMinMax(maxx: number, maxy: number, minx: number, miny: number, rotation: number) {
        return new BoundingBox(
    ...
    get topLeft() {
        return this.center.add(new Vector2(this.size.x * -.5, this.size.y * -.5)).rotate(this.rotation, this.center);
    }

    get topRight() {
        return this.center.add(new Vector2(this.size.x * 0.5, this.size.y * -.5)).rotate(this.rotation, this.center);
    }

    get bottomLeft() {
        return this.center.add(new Vector2(this.size.x * -.5, this.size.y * 0.5)).rotate(this.rotation, this.center);
    }

    get bottomRight() {
        return this.center.add(new Vector2(this.size.x * 0.5, this.size.y * 0.5)).rotate(this.rotation, this.center);
    }

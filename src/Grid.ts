...
export class Grid {
    ...
    public applyToTouchController(touchController: ITouchController): GridTouchController {
    ...
    public applyToTouch(touch: Touch): Touch {
        ...
        const gridTouch = new Touch(touch.type, touch.anchorElement, lastGridFrame, touch.externalIdentifier);
        ...
        touch.frames.subscribe(
            (frame) => {
                ...
                if (Vector.isEqual(gridFrame.position, lastGridFrame.position)){return; }
    ...
    public applyToTouchFrame(touchFrame: TouchFrame): TouchFrame {
        ...
        gridTouchFrame.position = Vector.fromVector(this.positionToGridPosition(touchFrame.position));
